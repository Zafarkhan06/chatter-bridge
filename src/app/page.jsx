...
export default function Home() {
  ...
  return (
    <>
          ...
          <div className="py-16 md:py-32 ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 mt-24 gap-10">
              <div className="flex justify-start items-start gap-3">
                ...
                <div>
                  <p className="text-[#161a0c] font-semibold text-2xl leading-none ">48% more crucial</p>
                  <p className="text-[#161a0c] text-sm mt-4 font-semibold">SMBs and enterprises now believe <br /> that AI will be  essential in protecting <br /> against cybersecurity risks and threats.
                  </p>
                </div>
              </div>
              ...
              <div className="flex justify-start items-start gap-3">
                ...
                <div>
                  <p className="text-[#161a0c] font-semibold text-2xl leading-none ">$2.09M saved per company</p>
                  <p className="text-[#161a0c] text-sm mt-4 font-semibold">Cybersecurity tools backed with AI <br />can bring savings of over $2.09 million per <br />company in the United States.</p>
                </div>
              </div>
      ...
      <div className=" bg-[#bada55] py-20 my-16">
        <h3 className="font-black leading-none text-[#161a0c] text-center">Ready to get started?
        </h3>
        <p className="text-[#161a0c] mt-6 font-semibold text-center">Explore how NETSOL's professional services can strengthen your infrastructure with unparalleled security and uncompromised services.
        </p>
