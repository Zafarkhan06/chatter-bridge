    ...
    <>
      <div className=" bg-[#afe57f] py-24 md:py-36">
        <Container maxWidth="xl">
          <div>
            <h1 className="font-black text-center leading-none uppercase text-[#172806]">
              {" "}
              Fueling Growth,
              <br /> Connecting the Best
            </h1>
            <h6 className="text-[#172806] tracking-tight leading-none text-center mt-10">
        ...
        <Container maxWidth="xl">
          <div className="grid grid-cols-1 md:grid-cols-2 items-end pt-10 gap-10 md:gap-20">
            ...
            <div className="md:order-1 text-center md:text-start my-auto">
              <h3 className="text-[#172806] font-bold uppercase leading-tight tracking-tight">
                Cultivating Growth through Teamwork
              </h3>
              <p className="text-[#172806] text-xl mt-6 md:mt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 mt-10 md:mt-20 items-start gap-8">
            <div className="flex">
              <div className="bg-[#afe57f] rounded-xl flex-grow shadow-inner p-8 py-12">
                <h4 className="font-black uppercase tracking-tight leading-none text-[#172806]">
                  Our Mission{" "}
                </h4>
                <p className="font-semibold text-lg md:text-2xl text-[#172806] mt-10 ">
      ...
      <div className="bg-white">
        <Container maxWidth="xl">
          <div className="py-10 md:py-20">
            <h3 className="font-black leading-none uppercase tracking-tight text-[#172806]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 mt-10 md:mt-20 items-start gap-8">
              <div className="flex">
                <div className="bg-[#afe57f] rounded-xl flex-grow shadow-inner p-8 py-16">
                  <h5 className="font-black uppercase tracking-tight leading-none text-[#172806]">
              ...
              <div className="flex">
                <div className="bg-[#172806] rounded-xl flex-grow shadow-inner p-8 py-16">
                  ...
                  <p className="font-semibold text-lg md:text-2xl text-white mt-10 pb-3 ">
