      ...
      <div className=" bg-[#192128] py-24 md:py-36">
        <Container maxWidth="xl">
          <div>
            ...
            <AnimatedWrapper from="right" delay={0.2} duration={0.7}>
            ...
            <AnimatedWrapper from="bottom" delay={0} duration={0.7}>
        ...
        <Container maxWidth="xl" >
          <div className="py-10 md:py-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 mt-10 md:mt-20 items-start gap-8">
              <AnimatedWrapper from="left" delay={0.3} duration={0.7}>
                <div className="flex">
              ...
              <AnimatedWrapper from="right" delay={0.3} duration={0.7}>
                <div className="flex">
