        ...
        <footer className="  px-5 md:px-10 rounded-2xl md:rounded-[60px] my-10">
            <div>
                <Container
                    ...
                    maxWidth="xl"
                >
                    <div className="relative text-[#E7E5E4] pt-10  md:pt-20">
                        <div className="container">
                            <div className="relative grid text-[#E7E5E4] lg:grid-cols-4 lg:gap-0 ">
                                <div className="col-span-1 w-full space-y-5 bg-[#E7E5E4] p-4 rounded-xl">
                                    <div className=''>
                                    ...
                                    <div className="flex items-center gap-3 ">
                                        <button type="button" className="ttnc-ButtonCircle flex items-center justify-center rounded-full !leading-none focus:ring-transparent disabled:bg-opacity-70 bg-custom-dark-gray w-10 h-10 ">
                                            <svg stroke="#192128" fill="#192128" stroke-width="0" viewBox="0 0 16 16" className="text-lg" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"></path></svg>
                                        </button>
                                        <button type="button" className="ttnc-ButtonCircle flex items-center justify-center rounded-full !leading-none focus:ring-transparent disabled:bg-opacity-70 bg-custom-dark-gray w-10 h-10 ">
                                            <svg stroke="#192128" fill="#192128" stroke-width="0" viewBox="0 0 16 16" className="text-lg" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="col-span-1 mt-6 md:mt-0 md:ml-6 bg-[#E7E5E4] p-4 px-5 rounded-xl">
                                    <h2 className="text-xl font-medium text-[#192128]">

                                        The ChatterBridge: Your Partner in Growth</h2>

                                    <div className="relative mt-5 max-w-sm text-[#192128]">
